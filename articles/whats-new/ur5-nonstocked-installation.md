...
description: Овај чланак пружа информације о начину ажурирања решења Project Operations у вашем Dynamics 365 Finance окружењу.
author: ruhercul
ms.date: 12/11/2020
ms.topic: article
ms.prod: ''
...
Овај чланак пружа информације о начину ажурирања решења Dynamics 365 Project Operations у вашем Dynamics 365 Finance окружењу. Постоје три процедуре потребне за ажурирање услуге Project Operations на исправку 5 (Microsoft Dynamics CRM 2011 Update Rollup 5):
...
7. У пољу **Мастер за почетну синхронизацију** изаберите **Апликације за финансије и операције**, а затим изаберите **Покрени**.
