...
description: Овај чланак пружа информације о томе како да креирате и потврдите корективне фактуре засноване на пројекту у услузи Project Operations.
author: rumant
ms.date: 03/29/2021
ms.topic: article
