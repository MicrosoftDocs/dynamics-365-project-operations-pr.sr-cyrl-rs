...
description: Овај чланак пружа информације о потврђивање фактуре засноване на проформа пројекту.
author: rumant
ms.date: 04/05/2021
ms.topic: article
...
ms.locfileid: "8929462"
---
# <a name="confirm-a-proforma-project-based-invoice"></a>Потврда предрачуна заснованог на пројекту
...
Фактурисање аванса или обуставе </p>
            ...
            <td width="408" valign="top">
                <p>
Фактурисани стварни износ продаје, <strong>Обустава</strong> креира се за износ на авансу или обустави.
                </p>
            </td>
        </tr>
        <tr>
            <td width="408" valign="top">
                <p>
Стварни износ ненаплаћене продаје са негативним износом обуставе или аванса који ће се користити за сравњење.
                </p>
            </td>
        </tr>
        <tr>
...
Нови ненаплаћени стварни износ продаје који је наплатив за сате и износ на детаљу линије уређене фактуре, сторнирање стварног износа продаје и еквивалентан стварни наплаћени износ продаје.
        ...
        <tr>
            <td width="408" valign="top">
                <p>
Нови стварни износ ненаплаћене продаје који се не наплаћује за преостале сате и износ након одбијања исправљених података на уређеном детаљу ставке фактуре, сторнирања стварне продаје и еквивалентни стварни износ наплаћене продаје.
                </p>
            </td>
        </tr>
        <tr>
