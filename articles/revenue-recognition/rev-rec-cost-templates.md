...
description: Овај чланак пружа информације о томе како да креирате и користите предлошке трошкова у услузи Project Operations.
author: sigitac
ms.date: 11/18/2020
ms.topic: article
...
Овај чланак пружа информације о томе како да креирате и користите предлошке трошкова у услузи Project Operations. Предложак трошкова одређује:
...
1. Да бисте приступили предлошцима трошкова, у Dynamics 365 Finance окружењу идите на **Управљање пројектима и рачуноводство** > **Конфигурација** > **Процене** > **Предложак цене**.
