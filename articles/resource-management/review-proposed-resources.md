...
description: Овај чланак пружа информације о томе како предложите ресурсе за пројекте.
author: ruhercul
ms.date: 08/18/2021
ms.topic: article
ms.prod: ''
...
3. У окну **Креирајте резервацију ресурса** подесите поље **Статус резервације** на **Предложено**, а затим изаберите **Резервиши**.
    ...
    - На захтеву ресурса, редактор захтева би требало да промени статус у **Захтева преглед**.
    - На картици **Тим** у оквиру пројекта, вредност генеричког члана тима **Статус захтева** се аутоматски мења у **Захтева преглед**.
