...
description: Овај чланак обезбеђује уобичајене обрасце за коришћење проширења за примену прилагођених поља.
author: Yowelle
ms.date: 05/29/2019
ms.topic: article
ms.prod: ''
...
Овај чланак обезбеђује уобичајене обрасце за коришћење проширења за примену прилагођених поља. Следећи чланци су обухваћени:
...
Овај чланак је намењен програмерима који интегришу своја прилагођена поља у Microsoft Dynamics 365 Project Timesheet мобилну апликацију која је доступна за Аппле иОС и Гоогле Android. Претпоставља се да су читаоци упознати са X++ развојем и функционалношћу временског распореда пројекта.
...
- Ако је својство **stringOptions** наведено на објекту **TSTimesheetCustomField**, ти елементи листе су једине вредности које корисници могу да изаберу помоћу дугмади са опцијама (радио дугмад).
    ...
    У овом случају, поље низа може деловати као нумеричка вредност у сврху уноса корисника. Да бисте сачували вредност у бази података као енум, ручно мапирајте вредност ниске на вредност енума пре него што је сачувате у бази података користећи ланац команди (погледајте одељак "Коришћење ланца команди на ТСТимесхеетЕнтрyСервице класи да бисте сачували ставку листа са временом из апликације назад у базу података" у каснијем чланку на пример).
...
Ово својство је применљиво само када се **fieldBaseType** подеси на **Низ**. Ако је **stringOptions** постављено, вредности низа које су доступне за избор преко опционалних дугмади (радио дугмади) одређене су низовима на листи. Ако нису обезбеђене ниске, дозвољена је ставка слободног текста у пољу ниске (погледајте одељак "Коришћење ланца команди на ТСТимесхеетЕнтрyСервице класи да бисте сачували ставку листа са временским листом из апликације назад у базу података" касније у овом чланку на пример).
