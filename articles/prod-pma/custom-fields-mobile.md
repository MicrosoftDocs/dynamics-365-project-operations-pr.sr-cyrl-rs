...
Ова тема пружа уобичајене обрасце за коришћење екстензија за примену прилагођених поља. Обухваћене су следеће теме:
...
Ова тема је намењена програмерима који интегришу прилагођена поља у Microsoft Dynamics 365 Project Timesheet апликацију за мобилне уређаје која је доступна за Apple iOS и Google Android. Претпоставља се да су читаоци упознати са X++ развојем и функционалношћу временског распореда пројекта.
