...
description: Овај чланак објашњава како да поставите стандардну цену рада и трошкове пројекта.
author: Yowelle
ms.date: 08/02/2019
...
Овај чланак објашњава како да поставите стандардну цену рада и трошкове пројекта. Овај задатке користи USSI скуп података.
