...
description: Овај чланак пружа информације о квалитетним исправкама које су доступне у октобру 2021.
author: andchoi
ms.date: 11/17/2021
ms.topic: article
ms.prod: ''
...
| Управљање пројектима и рачуноводство | [577857](https://fix.lcs.dynamics.com/Issue/Details/?bugId=577857) | Вредности дуговања и потраживања се мењају када се Microsoft Excel програмски додатак користи са налогом трошкова пројекта, а поље **Врста конта "Помак"** је подешено на "Пројекат **"**. |
...
| Управљање пројектима и рачуноводство | [598706](https://fix.lcs.dynamics.com/Issue/Details/?bugId=598706) | Апликација "Пројецт Тимесхеет Мобиле" престаје да се одазива Android. Проблем је повезан са **аргументом ТимеЕнтрyДатаМанагер АргументНуллЕxцептион**. |
