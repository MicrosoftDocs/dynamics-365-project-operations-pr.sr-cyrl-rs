...
description: Овај чланак пружа информације о апликацији за мобилне уређаје Microsoft Dynamics 365 Project Timesheet. Апликација за мобилне уређаје Project Timesheet омогућава корисницима да предају и одобре радне листове за пројекте на свом мобилном уређају.
author: abruer
ms.date: 06/29/2022
ms.topic: article
ms.prod: ''
...
Апликација за мобилне уређаје Microsoft Dynamics 365 Project Timesheet омогућава корисницима да предају и одобре радне листове за пројекте на свом мобилном уређају (iPhone или Android). Ова апликација за мобилне уређаје покрива функционалност временског распореда која се налази у области управљања пројектима и рачуноводства у услузи Dynamics 365 Finance. Она помаже у побољшању корисничке продуктивности и ефикасности, а такође омогућава правовремени унос и одобравање временских распореда пројеката.
...
### <a name="resolve-sign-in-issues"></a>Решавање проблема приликом пријављивања

**Проблем:** Током пријављивања у апликацију за мобилне уређаје Временски распоред пројекта, корисници примају поруку о грешци која каже да „не могу да приступе апликацији „2bc50526-cdc3-4e36-a970-c284c34cbd6e“ у том закупцу.“

**Проблем:** Током пријављивања у апликацију за мобилне уређаје Временски распоред пројекта, корисници примају грешку која личи на следеће примере:

- „AADSTS50020: Кориснички налог „[корисничко име]“ добављача идентитета „https://sts.windows.net/[ID апликације]“ не постоји у закупцу „[id закупаца]“ и не може да приступи апликацији „[id апликације]“ у том закупцу.“
- „Изабрани кориснички налог не постоји у закупцу „[id закупца]“ и није могуће приступити апликацији „[id апликације]“ у том закупцу“.

**Објашњење:** Ови проблеми су изазвани променом која је уведена у Azure Active Directory (Azure AD) у мају 2022. и која је повезана са спољним корисницима. Пошто ова промена није направљена у апликацијама за финансије и операције, она може да утиче на клијенте на било којој верзији платформе или апликације.

**Поправка:** Сви спољни корисници морају бити позвани у закупац помоћу услуге Azure AD. За више информација погледајте чланак [Позивање корисника са Azure Active Directory B2B сарадњом](/power-platform/admin/invite-users-azure-active-directory-b2b-collaboration).
