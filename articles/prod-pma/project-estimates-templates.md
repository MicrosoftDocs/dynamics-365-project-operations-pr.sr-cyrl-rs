...
У предлошку за процену сата пројекта морате да користите Мицрософт за Power Query Еxцел да бисте довршили ове задатке:
...
- Ако креирате нови образац, морате додати ову колону. У Power Query изаберите опцију **Додај условну колону** и унесите име нове колоне, као што је **ИД модела**. Унесите услов за колону, где, ако Project задатак није без вредности , онда \<enter the forecast model ID\>; у супротном је без вредности.
...
У предлошку за процену трошкова пројекта морате користити за Power Query довршавање следећих задатака:
...
- Ако користите подразумевани предложак трошкова пројекта (ПСА то Фин анд Опс), у Power Query одељку Примењени **кораци** изаберите **први уметнути** услов. У ставци **Функција**, замените **O\_forecast** називом ID-а модела предвиђања који треба користити уз интеграцију. Подразумевани предложак садржи ID модела предвиђања из демо података.
- Ако креирате нови образац, морате додати ову колону. У Power Query изаберите опцију **Додај условну колону** и унесите име нове колоне, као што је **ИД модела**. Унесите услов за колону, где, ако ID линије процене није без вредности , онда \<enter the forecast model ID\>; у супротном је без вредности.
