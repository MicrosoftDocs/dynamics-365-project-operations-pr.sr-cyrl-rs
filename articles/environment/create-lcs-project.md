...
description: Овај чланак пружа информације о креирању новог пројекта у LCS-у за ваше Project Operations окружење.
author: stsporen
ms.date: 10/01/2020
ms.topic: article
...
5. Именујте пројекат. 
6. Изаберите **Финансије и операције** као назив производа и изаберите делатност и методологију. 
7. Изаберите **Креирај**.
