...
description: Овај чланак пружа списак мапа двоструког уписивања потребних за Dynamics 365 Project Operations.
author: sigitac
ms.date: 07/01/2021
ms.topic: article
...
1. На листи мапа одаберите мапу Главна књига **(msdyn\__ledgers)** са свим предусловима и означите поље за потврду **Почетна синхронизација**. У пољу **Мастер за почетну синхронизацију**, изаберите **Апликације за финансије и операције** и за мапу главне књиге и за све предусловне карте. Изаберите **Покрени**.
...
| Мапа ентитета | Најновија верзија | Почетна синхронизација | Потребна Dynamics 365 Finance верзија |
| --- | --- | --- | --- |
...
| Табела интеграције пројекта за процене материјала (msdyn\__estimatelines) | 1.0.0.0 | Није потребно за резервисање. ||
...
| Project Operations ентитет извоза фактуре добављача (msdyn_projectvendorinvoices) | 1.0.0.2 | Није потребно за резервисање. |10.0.29 или новији|
| Project Operations ентитет извоза реда фактуре добављача (msdyn_projectvendorinvoicelines) | 1.0.0.5 | Није потребно за резервисање. | 10.0.29 или новији |
