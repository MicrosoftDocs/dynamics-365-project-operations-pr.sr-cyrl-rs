...
description: Овај чланак пружа информације о одредницама перформанси АПИ-ја распореда пројекта и идентификује најбоље праксе за оптималну употребу.
author: ruhercul
ms.date: 11/03/2021
ms.topic: article
...
Овај чланак пружа информације о одредницама перформанси програмских интерфејса апликације Пројецт сцхедуле (АПИ) и идентификује најбоље праксе за оптимизацију коришћења.
...
АПИ -је за планирање пројекта ослањају се на услугу заказивања пројекта да би покренули захтеве који су детаљније описани у каснијим одељцима овог чланка.
