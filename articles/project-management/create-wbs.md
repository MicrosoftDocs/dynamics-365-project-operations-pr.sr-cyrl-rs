...
description: Овај чланак објашњава како да креирате структурну анализу посла (САП) која укључује основне контроле у новом интерфејсу за планирање.
author: ruhercul
ms.date: 12/16/2021
ms.topic: article
...
Атрибутима ангажовања се приступа у пољу **Ресурси** у распореду. Можете потражити постојећи ресурс или изаберите **Креирај** и у окну **Брзо креирање** додајте члана пројектног тима као нови ресурс.  Када тражите ресурс користећи бирач ресурса у матрици координатне мреже задатака, приказу табле или гантовом дијаграму, претрага враћа постојеће чланове пројектног тима или активне ресурсе који се могу књижити.
...
## <a name="understanding-the-impacts-of-duration-resource-calendars-and-project-calendars-on-tasks"></a>Разумевање утицаја трајања, календара ресурса и пројектних календара на задатке
Трајање задатка се дефинише као број радних сати између времена почетка датума почетка и времена завршетка датума завршетка задатка.   Project for the Web дефинише јединице мере трајања на следећи начин:
...
Недодељени задаци се заказују помоћу календара пројекта. Међутим, након почетне доделе ресурса, планирање задатка се ажурира тако да поштује календар ресурса. Накнадне промене задатка који има доделу биће регулисане [режимом заказивања](scheduling-modes.md) пројекта. Да бисте сазнали више о утицају календара на задатке, погледајте чланке [Календари ресурса у решењу Project for the Web](https://techcommunity.microsoft.com/t5/project-blog/resource-calendars-in-project-for-the-web/ba-p/3269686) и [Времена почетка задатка и ваши пројекти!](https://techcommunity.microsoft.com/t5/project-blog/task-start-times-amp-your-projects/ba-p/3269665)
