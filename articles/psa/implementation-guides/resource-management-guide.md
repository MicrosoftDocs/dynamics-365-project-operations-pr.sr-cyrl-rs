...
description: Овај чланак пружа везе ка информацијама о управљању ресурсима у апликацији Project Service Automation
author: kfend
ms.custom:
...
PDF веза која је претходно била у овом чланку уклоњена је, а садржај је премештен у следеће чланке:
...
> [!NOTE]
> Овај чланак биће уклоњен у будућој исправци документације. 
