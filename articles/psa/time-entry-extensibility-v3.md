...
description: Овај чланак пружа информације о примени прилагођених пословних правила која подржавају праксе организације.
author: stsporen
ms.custom:
...
Одељак **Димензије** не дозвољава унутрашње уређивање. Овај одељак је подржан приказом који омогућава да се прилагођена поља додају у мрежу седмичних ставки времена. Више информација о додавању прилагођених поља потражите у одељку "Протензибилност" у овом чланку.
