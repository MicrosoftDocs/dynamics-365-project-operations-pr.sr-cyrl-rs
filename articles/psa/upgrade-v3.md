...
description: Овај чланак пружа информације о разматрањима која морате да извршите приликом надоградње са верзије 2.x или 1.x на верзију 3.
ms.prod: ''
ms.custom:
...
Ове промене утичу на надоградњу свих постојећих пројеката који имају доделе ресурса за именоване ресурсе који се могу резервисати и генеричке ресурсе у тиму пројекта. Овај чланак обезбеђује разматрања која ће вам бити потребна да узмете у обзир за своје пројекте када извршите надоградњу на верзију 3. 
