...
Предложак пројекта можете да креирате из пројекта на следеће начине:

- **Структурна анализе посла**: Структурна анализа посла у предлошку који је изведен из пројекта копираће све задатке и зависности. Креиране доделе биће засноване на генеричким члановима тима који се додају пројектном тиму када се креира предложак пројекта.
...
- **Чланови пројектног тима**: Када се предложак креира из постојећег пројекта, сви именовани чланови тима биће замењени генеричким ресурсом организације. Одржавају се сви називи позиција и улоге.
