...
description: Овај чланак пружа преглед димензија цена.
author: rumant
ms.custom:
...
Ако је потребно да одредите цену или трошкове ресурса помоћу додатних атрибута, можете да креирате прилагођена поља, ентитете и димензије. Више информација потражите у следећим чланцима, међутим имајте на до знању да морате да довршите процедуре редоследом наведеним испод:
