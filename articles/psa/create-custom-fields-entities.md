...
description: Овај чланак садржи објашњења о томе како да креирате скупове опција и ентитете у сопственом решењу на Power Apps платформи.
author: Rumant
ms.custom:
...
Процедуре у овом чланку би требало да буду довршене коришћењем веб интерфејса пројецт сервице аутоматион (ПСА).
