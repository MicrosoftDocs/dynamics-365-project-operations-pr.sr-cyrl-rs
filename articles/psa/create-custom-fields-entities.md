...
description: Овај чланак објашњава како се креирају скупови опција и ентитети у решењу платформе Power Apps.
author: Rumant
ms.custom:
...
Процедуре у овом чланку би требало да буду завршене коришћењем веб-интерфејса апликације Project Service Automation (PSA).
