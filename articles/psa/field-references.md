...
description: Овај чланак пружа информације о додавању прилагођених поља у подешавање цена и трансакционим ентитетима.
author: Rumant
ms.custom:
...
Овај чланак претпоставља да сте довршили процедуре у чланку Креирајте прилагођена [поља и ентитете](create-custom-fields-entities.md). Ако нисте завршили те процедуре, вратите се и довршите их, а затим се вратите на овај чланак. 
