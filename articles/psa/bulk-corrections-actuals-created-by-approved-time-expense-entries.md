...
description: Овај чланак објашњава како администратор може да изврши појединачне или масовне исправке претходно одобрених ставки времена или трошка уколико наплата није потпуна.
author: rumant
ms.date: 04/02/2020
ms.topic: article
...
Да бисте довршили процедуре у овом чланку, требаће вам дозволе администратора.
