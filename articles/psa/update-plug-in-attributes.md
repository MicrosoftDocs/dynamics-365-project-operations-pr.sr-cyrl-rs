...
description: Овај чланак пружа информације о ажурирању атрибута додатне компоненте за димензије цена.
author: Rumant
ms.custom: ''
ms.date: 11/19/2018
ms.topic: article
...
> [!NOTE]
> Ако не користите функције за аутоматизацију услуге пројекта (ПСА) за цитирање и уговарање, можете да прескочите овај чланак.

Овај чланак претпоставља да сте довршили процедуре у чланцима, [креирали прилагођена поља и ентитете,](create-custom-fields-entities.md) додали прилагођена поља [у подешавање цена и трансакционе ентитете и](field-references.md) подесили прилагођена поља [као димензије цена](set-up-pricing-dimensions.md). Ако нисте завршили те процедуре, вратите се и довршите их, а затим се вратите на овај чланак.
