...
description: Овај чланак пружа информације о томе како се димензије цена могу користити за подршку ценама и трошковима ресурса који попуњава више улога у пројекту.
author: rumant
ms.custom:
