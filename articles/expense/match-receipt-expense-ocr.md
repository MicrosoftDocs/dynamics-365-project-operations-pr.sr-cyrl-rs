...
description: Овај чланак пружа информације о обради признаница помоћу оптичког препознавања знакова (OCR).
author: suvaidya
ms.date: 11/10/2021
ms.topic: article
ms.prod: ''
...
Да бисте користили ове напредне могућности трошкова, инсталирајте програмски додатак Услуга управљања трошковима за Microsoft Dynamics 365 Finance и укључите функције у вашој инстанци. Програмском додатку можете приступити из свог пројекта у услузи Microsoft Dynamics Lifecycle Services (LCS).
...
Доступност ове функције у различитим регионима наведена је у следећој табели. Ако ваш регион тренутно није подржан, проследите захтев за одређивање приоритета доступности OCR услуге у вашем региону. 
...
| АУС    | Да                               |
| ЕУ     | Делимично. Само потврде на енглеском. |
| Азија   | No                                |
| Јапан  | No                                |
| Африка | No                                |
