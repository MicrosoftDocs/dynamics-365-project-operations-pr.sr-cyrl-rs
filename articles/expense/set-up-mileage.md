...
description: Овај чланак пружа информације о километражи и нивоима километраже.
author: suvaidya
ms.date: 05/20/2021
ms.topic: article
...
## <a name="enable-the-mileage-totals-calculation-by-fiscal-year-feature"></a>Омогућавање израчунавање укупне километраже према функцији фискалне године

Функција **Укупно израчунавање километраже по фискалној години** омогућава нову поставку у параметрима управљања трошковима која обавља израчунавања укупне километраже за фискалну годину уместо у календарској години. Довршите следеће кораке да бисте омогућили ову функцију.

1. Идите на ставку **Радни простори** > **Управљање функцијама**.
1. На листи пронађите и изаберите **Израчунавање укупне километраже по фискалној години**, а затим изаберите **Омогући одмах**.
1. Идите на **Управљање трошковима** > **Инсталација** > **Општи подаци** > **Параметри управљања трошковима**.
1. На страници **Параметри управљања трошковима** пронађите и омогућите **Коришћење фискалне године за укупну километражу**.

Када омогућите **Коришћење фискалне године за укупну километражу**, укупна километража се израчунава по фискалној години.
