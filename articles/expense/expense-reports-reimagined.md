---
title: Поновно осмишљени извештаји о трошковима (садржи видео запис)
description: Овај чланак објашњава редизајнирано и прерађено искуство за унос извештаја о трошковима.
author: suvaidya
ms.date: 12/16/2021
ms.topic: article
ms.prod: ''
...
|Брза подела периодичних трошкова | Редизајниран радни простор трошкова обезбеђује могућност брзе поделе периодичних трошкова додавањем поткатегорије, датума почетка и количине. Количина се односи на број понављања наплате током континуираног периода. |
