...
description: Овај чланак објашњава како се ради са трансакцијама кредитном картицом повезаним са трошковима.
author: suvaidya
ms.date: 11/17/2021
ms.topic: article
ms.prod: ''
...
Понекад, након увоза трансакција кредитном картицом, одређене трансакције можда треба избрисати. То је можда зато што су трансакције дупликати или што подаци нису тачни. Администратори могу да користе функцију **„Брисање трансакција кредитном картицом“** за одабир и брисање трансакција кредитном картицом које **нису приложене** на извештај о трошковима. 
...
- **Спречавање уноса броја картице** – Бројеви кредитних картица се не чувају.
- **Хеширај бројеве картица (складишти последње четири цифре)** – Последње четири цифре бројева кредитних картица складиште се у шифрованом формату.
- **Складишти бројеве картица** – Бројеви кредитних картица складиште се у нешифрованом формату. Ова опција није у складу са Стандардом безбедности података индустрије платних картица (PCI) (DSS). Стога, да би њихова организација била усаглашена са PCI DSS прописима, администратори организације би требало да изаберу да не складиште бројеве кредитних картица или да складиште хеширане бројеве картица.
