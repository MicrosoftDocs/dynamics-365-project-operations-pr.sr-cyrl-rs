...
## <a name="upload-a-project-file-to-sharepoint-or-office-groups"></a>Отпремање датотеке пројекта у SharePoint или Office групе  
 Датотеку пројекта можете да отпремите у SharePoint и да је пронађете у оквиру опције „Повезани документи“ за [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)] пројекат.  Администратор мора да конфигурише SharePoint управљање документима и да га укључите за ентитет Пројекат. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Подешавање SharePoint интеграције](../admin/set-up-sharepoint-integration.md)  

 Можете и да отпремите датотеку пројекта у [!INCLUDE[pn_onedrive_for_business](../includes/pn-onedrive-for-business.md)] ако имате подешену опцију Office групе. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Сарадња са колегама коришћењем Office 365 група](../basics/collaborate-with-colleagues-using-office-365-groups.md)  
