...
Овај чланак пружа информације о ажурирању атрибута додатне компоненте за димензије цена.

> [!NOTE]
> Овај чланак је применљив само на функције понуде и уговора у програму Dynamics 365 Project Operations.

## <a name="prerequisites"></a>Предуслови
Пре него што довршите кораке из овог чланка, морате довршити процедуре у следећим чланцима:
