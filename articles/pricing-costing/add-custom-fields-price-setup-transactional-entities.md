...
description: Овај чланак пружа информације о томе како да ентитетима и обрасцима и приказима додате потребне референце на прилагођена поља.
author: rumant
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
...
Овај чланак претпоставља да сте довршили процедуре у чланку, креирајте прилагођена [поља и ентитете који ће се користити као димензије цена](create-custom-fields-entities-pricing-dimensions.md). Ако нисте завршили те процедуре, вратите се и довршите их, а затим се вратите на овај чланак. 

У овом чланку, процедуре ће вам показати како да ентитетима и елементима корисничког интерфејса (корисничког интерфејса) додате потребне референце на прилагођена поља, као што су обрасци и прикази.
