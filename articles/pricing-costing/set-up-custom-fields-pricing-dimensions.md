...
description: Овај чланак пружа информације о томе како да подесите димензије цена помоћу прилагођених поља.
author: rumant
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
...
Пре него што почнете, овај чланак претпоставља да сте довршили процедуре у чланцима, [креирајте прилагођена поља и ентитете и додајте потребна прилагођена поља](create-custom-fields-entities-pricing-dimensions.md)[у подешавање цена и трансакционе ентитете](add-custom-fields-price-setup-transactional-entities.md). Ако нисте завршили те процедуре, вратите се и довршите их, а затим се вратите на овај чланак. 

Овај чланак пружа информације о подешавању прилагођених димензија цена. На страници **Параметри**, на картици **Димензије за одређивање цена засноване на износима**, приказују се записи у ентитетима димензије за одређивање цена. На мрежи се на овој картици подразумевано налазе два реда у мрежи:
