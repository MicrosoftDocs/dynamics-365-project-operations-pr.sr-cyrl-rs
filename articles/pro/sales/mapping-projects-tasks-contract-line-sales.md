---
title: Мапирање пројеката и задатака на предмет уговора за пројекат
description: Овај чланак пружа информације о додавању и уклањању пројеката и задатака у предмет уговора.
author: rumant
ms.date: 10/27/2020
ms.topic: article
...
ms.locfileid: "9825077"
---
# <a name="map-projects-and-tasks-to-a-project-contract-line"></a>Мапирање пројеката и задатака на предмет уговора за пројекат 
...
У редовима уговора о пројекту можете мапирати одређене задатке у пројекту до реда уговора.
...
## <a name="associate-tasks-to-project-contract-lines"></a>Повезивање задатака са редовима уговора о пројекту
