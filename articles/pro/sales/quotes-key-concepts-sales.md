---
title: Концепти јединствени за понуде за пројекат
...
- Понуде за продају вам омогућавају да приложите више поруџбина понуди за продају. У пројектне операције само један уговор о пројекту може бити приложен понуди за пројекат.
...
- Понуда за продају не укључује нека поља и концепте који су укључени у понуду пројекта. У поља спадају **Уговорна јединица**, **Менаџер за пословне контакте** и **Име контакта за фактурисање**.  
