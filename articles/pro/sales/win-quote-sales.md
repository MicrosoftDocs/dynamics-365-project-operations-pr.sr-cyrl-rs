---
title: Затварање понуда за пројекат
...
ms.locfileid: "9826194"
---
# <a name="close-project-quotes"></a>Затварање понуда за пројекат
...
## <a name="closing-a-quote-as-lost"></a>Затварање понуде као изгубљене
