...
description: Овај чланак пружа информације о копирању уговора за пројекат у услузи Project Operations.
author: rumant
ms.date: 10/07/2020
ms.topic: article
...
ms.locfileid: "9410185"
---
# <a name="copy-project-contracts"></a>Копирање уговора за пројекат
