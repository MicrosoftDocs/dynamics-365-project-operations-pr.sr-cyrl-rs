---
title: Детаљи заглавља за понуде за пројекат
description: Овај чланак пружа информације о информацијама и подешавањима који се односе на понуде за пројекте и утичу на њих. (Sales)
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "9824859"
---
# <a name="header-details-for-project-quotes"></a>Детаљи заглавља за понуде за пројекат
