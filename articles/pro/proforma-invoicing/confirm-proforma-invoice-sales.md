...
Након потврде предрачуна, статус фактуре пројекта се ажурира на **Потврђено**. Када се фактура потврди, постаје само за читање. Убудуће се фактура може исправити само ако постоје исправке или кредити које је покренуо клијент, или уколико је фактура означена као плаћена.
    ...
    <tbody>
        ...
        <tr>
            <td width="216" rowspan="2" valign="top">
                <p>
Фактурисање аванса или одбитка </p>
            </td>
