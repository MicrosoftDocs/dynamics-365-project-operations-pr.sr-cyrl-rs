---
title: Подешавање стопа наплате за рад
...
ms.locfileid: "4084034"
---
# <a name="setting-up-bill-rates-for-labor-rate-billing"></a>Постављање стопа наплате за обрачун стопе рада 
...
2. На картици **Улога цена** , у подмрежи одаберите **+ Нова цена улоге**. 
