...
Приоритет коришћења набавне цене специфичне за улогу у односу на ресурсе подстакнут је подешавањем приоритета димензије **цена у димензијама "Параметри&гт; димензијама цена заснованих на износу**.
