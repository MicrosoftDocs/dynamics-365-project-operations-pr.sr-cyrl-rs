...
4. На страници **Нова контролна тачка за предмет подуговора** унесите потребне податке на основу следеће табеле.
    ...
    | Поље | Опис |
    | --- | --- |
    | Назив контролне тачке | Назив контролне тачке. |
    | Опис | Опис контролне тачке.  |
    | Датум контролне тачке | Датум када би процес аутоматског креирања фактуре требало да тражи статус ове контролне тачке како би се узео у обзир за фактурисање. Ова вредност је укључена у фактуру продавца приликом фактурисања за овај подуговор. |
    | Износ | Износ или вредност контролне тачке која ће се фактурисати клијенту. Ова вредност је укључена у фактуру продавца приликом фактурисања за овај подуговор. |
    | Порез | Износ пореза примењен на контролну тачку. Ова вредност је укључена у фактуру продавца приликом фактурисања за овај подуговор. |
    | Износ са порезом | Ово поље само за читање које се израчунава као износ + порез. Ова вредност је укључена у фактуру продавца приликом фактурисања за овај подуговор. |
