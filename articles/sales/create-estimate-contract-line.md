...
---
# <a name="estimate-a-projectbased-contract-line"></a>Процена ставке понуде засноване на пројекту
...
## <a name="create-an-estimate-directly-on-a-projectbased-contract-line"></a>Креирање процене директно на предмету уговора заснованом на пројекту
...
| **Предузеће које одређује ресурсе** | **Брзо креирање** | Компанија или правно лице које одређује ресурсе и које сноси овај трошак и обезбеђује ресурсе за рад на њима. | Ово поље подразумева детаље повезаног предмета уговора за трошкове који се аутоматски креирају. Ово поље се такође користи за проналажење цене коштања. |
