...
description: Овај чланак пружа информације о понудама за пројекат и понудама за продају које су доступне у операцијама пројекта.
author: rumant
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
...
Овај чланак је фокусиран на детаље пројектне понуде.
