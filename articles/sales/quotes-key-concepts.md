...
description: Овај чланак пружа информације о понудама за пројекте и понудама за продају које су доступне у услузи Project Operations.
author: rumant
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
...
Овај чланак се фокусира на детаље понуда пројеката.
