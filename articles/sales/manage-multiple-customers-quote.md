...
ms.locfileid: "3908566"
---
# <a name="manage-multiple-customers-on-project-quotes"></a>Управљање са више клијената у понудама за пројекат
...
Клијенти понуде и клијенти ставке понуде могу да се додају, ажурирају или бришу у било ком тренутку пре остварења понуде. Важећи клијент у понуди мора бити подешен као клијент у предузећу-власнику или правном лицу на страници **Клијенти**. Правна лица се подешавају у модулу **Управљање пројектима и рачуноводство** услуге Dynamics 365 Project Operations и доступна су као компаније у модулима **Пројектна продаја и испорука** услуге Project Operations.
