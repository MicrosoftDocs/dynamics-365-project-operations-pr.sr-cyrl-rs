...
description: Овај чланак садржи објашњења о томе како се димензије цена користе за подршку проценама цена и трошкова за ресурс који попуњава више улога на пројекту.
author: rumant
ms.date: 11/16/2020
ms.topic: article
