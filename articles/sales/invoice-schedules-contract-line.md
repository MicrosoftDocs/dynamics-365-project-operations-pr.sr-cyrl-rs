---
title: Креирање распореда фактура у реду уговора заснованом на пројекту
...
ms.locfileid: "9825116"
---
# <a name="create-invoice-schedules-on-a-project-based-contract-line"></a>Креирање распореда фактура у реду уговора заснованом на пројекту
