...
description: Овај чланак пружа информације о укљученим компонентама понуде које се наплаћују, наплаћују и које се не наплаћују у редовима понуде засноване на пројекту.
author: rumant
ms.date: 11/18/2020
ms.topic: article
