---
title: Управљање потенцијалним клијентима заснованим на пројекту
description: Овај чланак пружа информације о управљању потенцијалним клијентима заснованим на пројекту.
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "9825818"
---
# <a name="manage-project-based-leads"></a>Управљање потенцијалним клијентима заснованим на пројекту
...
## <a name="create-a-new-project-based-lead"></a>Креирање новог потенцијалног клијента заснованог на пројекту 
