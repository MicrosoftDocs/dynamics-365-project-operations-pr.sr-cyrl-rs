---
title: Затварање понуда заснованих на пројекту
description: Овај чланак пружа информације о затварању понуда у услузи Project Operations.
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "9824236"
---
# <a name="close-project-based-quotes"></a>Затварање понуда заснованих на пројекту

_**Односи се на:** Project Operations за сценарије засноване на ресурсима / без залиха_

Понуда пројекта може бити затворена као освојена  **или**  изгубљена **·**. 
